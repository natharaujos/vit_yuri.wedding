    ...
    <div className="mt-12 max-w-3xl">
      ...
      <div className="flex justify-center mb-6">
        <div className="flex items-center gap-3">
          <div className="h-px w-12 bg-gradient-to-r from-transparent to-[#FF69B4]/50"></div>
          <svg className="w-6 h-6 text-[#FF69B4]" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
          </svg>
          <div className="h-px w-12 bg-gradient-to-l from-transparent to-[#FF69B4]/50"></div>
        </div>
      </div>
      ...
      <div className="relative">
        {/* Sombra suave atrás */}
        <div className="absolute inset-0 bg-gradient-to-br from-pink-100 to-rose-100 rounded-3xl blur-xl opacity-40"></div>
        
        <div className="relative bg-white/80 backdrop-blur-lg shadow-xl px-8 py-10 md:px-12 md:py-12 rounded-3xl border border-pink-100/50">
